    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            <Ionicons name="time-outline" size={25} color={"#89adad"} />
            <Text style={{ color: "#89adad", fontSize: 18 }}>History</Text>
          </TouchableOpacity>
        </View>
      </View>
      <ScrollView>
        <View style={{ paddingTop: 15 }}>
          ...
          <RewardsCard
            name={"meesho"}
            title={"10$ gift Card on Meesho"}
            currentpoints={1000}
            totalpoints={2000}
          />
          <RewardsCard
            name={"best_buy"}
            title={"50$ gift Card on Best Buy"}
            currentpoints={150}
            totalpoints={1000}
          />
          <RewardsCard
