      ...
      <ScrollView style={styles.scrollarea}>
        ...
        <View style={styles.personalInfoTop}>
          <View style={styles.imageContainer}>
              <Image source={require('../../assets/pic_sample.jpg')} style={styles.image_profile} />
          </View>
          <View style={styles.top_profile_left}>
            <Text style={styles.colorslight}>ARYAN KOHLI
            </Text>
            ...
            <Ionicons name="warning" size={25} color={"#ad7736"} />
             <Text style={[styles.colorslight_grey,{marginLeft:10}]}>Not Verified</Text>
            </View>
            }
        ...
        <View style={styles.playingExperienceContainer}>
          ...
          <View style={styles.contestRecordBox}>
            ...
            <Text style={styles.contestRecordBoxPointsDesc}>Total Contest</Text>
          </View>
          <View style={styles.contestRecordBox}>
          ...
          <View style={styles.basicInfoBox}>
            <View style={styles.basicInfoRow1}>
                <View style={{width:"35%"}}>
                  ...
                  <Text style={[styles.colorslight_grey, {fontSize:12}]}>12/12/2007</Text>
                </View>
                <View style={{width:"38%"}}>
                  <Text style={[styles.colorslight_grey]}>Gender</Text>
                  <Text style={[styles.colorslight_grey, {fontSize:12}]}>Male</Text>
                </View>
            </View>
            <View style={styles.basicInfoRow2}>
                <View style={{width:"35%"}}>
                  <Text style={[styles.colorslight_grey]}>Country</Text>
                  <Text style={[styles.colorslight_grey, {fontSize:12}]}>India</Text>
                </View>
                <View style={{width:"38%"}}>
                  <Text style={[styles.colorslight_grey]}>State</Text>
                  <Text style={[styles.colorslight_grey, {fontSize:12}]}>Arunachal Pradesh</Text>
                </View>
            </View>
          </View>
          </View>   
