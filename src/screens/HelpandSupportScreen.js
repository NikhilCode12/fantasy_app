    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={{ margin: 20 }}>
          <Text
            style={{ fontSize: 18, color: COLORS.light, fontWeight: "700" }}
          >
        ...
        <View style={styles.AllQuestionMain}>
          ...
          >
            <Text style={styles.questionText}>
              I haven't receive my withdrawl money , what should I do ?
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.questionContainer}
          ...
          >
            <Text style={styles.questionText}>
              I can't see my added money , what should I do ?
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.questionContainer}
          ...
          >
            <Text style={styles.questionText}>
              I Want to Withdraw , how do I verify ?
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.questionContainer}
        ...
        <View style={{ marginHorizontal: 20 }}>
          <View>
            <Text
              style={{ fontSize: 18, fontWeight: "900", color: COLORS.light }}
            >
              CONTACT US :
            </Text>
          </View>
