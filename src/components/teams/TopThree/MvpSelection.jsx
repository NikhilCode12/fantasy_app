...
import PlayerMvpComponent from "./PlayerMvpComponent.jsx";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          {"Select your MVP Captain and Vice-Captain"}
        </Text>
        <Text
          style={[
            styles2.playersText,
      ...
      <View style={styles2.topContainer}>
        ...
        >
          ...
          <TouchableOpacity onPress={() => {}}>
            <Text style={styles2.topTitle}>BY %VC</Text>
          </TouchableOpacity>
        </View>
      </View>
      <ScrollView
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (captainName === "" && viceCaptainName === "" && mvpName == "") {
            ToastAndroid.show(
              "Please Select Captain , Vice captain & Mvp",
              ToastAndroid.SHORT
            );
          } else if (captainName === "") {
            ...
            ToastAndroid.show("Please Select Mvp ", ToastAndroid.SHORT);
          } else {
