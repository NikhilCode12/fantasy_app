...
export default function T10Rules() {
  ...
  const battingPoints = [
    ...
    {
      t: "Above 190 runs per 100 balls",
      p: "+6 pts",
      flag: true,
    },
    {
      t: "Between 170.01-190 runs per 100 balls",
      p: "+4 pts",
      flag: true,
    },
    {
      t: "Between 150-170 runs per 100 balls",
      p: "+2 pts",
      flag: true,
    },
    {
      t: "Between 70-80 runs per 100 balls",
      p: "-2 pts",
      flag: false,
    },
    {
      t: "Between 60-69.99 runs per 100 balls",
      p: "-4 pts",
      flag: false,
    },
    {
      t: "Below 60 runs per 100 balls",
      p: "-6 pts",
      flag: false,
    },
  ];
  const bowlingPoints = [
    ...
    {
      t: "Below 7 runs per over",
      p: "+6 pts",
      flag: true,
    },
    {
      t: "Between 7 - 7.99 runs per over",
      p: "+4 pts",
      flag: true,
    },
    {
      t: "Between 8 - 9 runs per over",
      p: "+2 pts",
      flag: true,
    },
    {
      t: "Between 14 - 15 runs per over",
      p: "-2 pts",
      flag: false,
    },
    {
      t: "Between 15.01 - 16 runs per over",
      p: "-4 pts",
      flag: false,
    },
    {
      t: "Above 16 runs per over",
      p: "-6 pts",
      flag: false,
    },
  ];
        ...
        <View style={styles.container}>
          ...
          {battingOpened &&
            battingPoints.map((rule) => {
              if (rule.t === "Above 190 runs per 100 balls") {
                return (
                  <View key={rule.t}>
