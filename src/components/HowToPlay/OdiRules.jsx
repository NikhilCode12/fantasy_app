...
export default function OdiRules() {
  ...
  const battingPoints = [
    ...
    {
      t: "Above 140 runs per 100 balls",
      p: "+6 pts",
      flag: true,
    },
    {
      t: "Between 120.01-140 runs per 100 balls",
      p: "+4 pts",
      flag: true,
    },
    {
      t: "Between 100-120 runs per 100 balls",
      p: "+2 pts",
      flag: true,
    },
    {
      t: "Between 40-50 runs per 100 balls",
      p: "-2 pts",
      flag: false,
    },
    {
      t: "Between 30-39.99 runs per 100 balls",
      p: "-4 pts",
      flag: false,
    },
    {
      t: "Below 30 runs per 100 balls",
      p: "-6 pts",
      flag: false,
    },
  ];
  const bowlingPoints = [
    ...
    {
      t: "Below 2.5 runs per over",
      p: "+6 pts",
      flag: true,
    },
    {
      t: "Between 2.5 - 3.49 runs per over",
      p: "+4 pts",
      flag: true,
    },
    {
      t: "Between 3.5 - 4.5 runs per over",
      p: "+2 pts",
      flag: true,
    },
    {
      t: "Between 7 - 8 runs per over",
      p: "-2 pts",
      flag: false,
    },
    {
      t: "Between 8.01 - 9 runs per over",
      p: "-4 pts",
      flag: false,
    },
    {
      t: "Above 9 runs per over",
      p: "-6 pts",
      flag: false,
    },
  ];
